...
typedef enum
{
	...
	OTA_USB_CONNECT,
    OTA_FIRMWARE_UPDATE_SUCESS_REBOOT,
}OTA_STEP;
...
extern Rc_t larktms_client_check(const char *szUrl,char *version);
extern Rc_t larktms_client(const char *szUrl,char *version);
#endif
