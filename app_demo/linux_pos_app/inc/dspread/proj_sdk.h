...
#define LCD_DISP_NFC_TAP_TRY_AGAIN         (117)
#define LCD_DISP_NFC_TRADE_SUCCESS         (118)
#define LCD_DISP_MAG_TRADE_SUCCESS         (119)
#define LCD_DISP_MAG_TRADE_FAIL            (120)
...
extern void emvPorcessDisplay(pmessage_body_t pmsg);
extern void emvSelectMultiApp( unsigned char * tlvData );
/*-----------------------------------------------------------------------------
|   transaction APIs
+----------------------------------------------------------------------------*/
