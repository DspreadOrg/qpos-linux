...
// Initialize the server socket address
	...
	servaddr.sin_port = htons(port);//The port of the server you want to connect to
	servaddr.sin_addr.s_addr = inet_addr(ip);//The IP address of the server
...
// Connection failed
	...
	OsLog(LOG_INFO,"connect socket success\n");
	*socket_fd = sockfd;
	return 0;
}
