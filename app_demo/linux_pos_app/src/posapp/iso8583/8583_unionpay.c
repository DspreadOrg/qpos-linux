...
// POSP test in BCTC direct connection detection found that the background returned to the 63 domain incorrect format, so if the 63 domain error occurs, it will be ignored 2010-5-18 liuxiling
