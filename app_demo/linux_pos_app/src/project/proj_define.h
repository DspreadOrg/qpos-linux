...
#define TRACE_LVL_NOTICE        (1)
#define TRACE_LVL_DEFAULT       (1)
#define TRACE_LVL_INFO          (LOG_INFO)
#define TRACE_LVL_DRIVER        (1)
#define TRACE_LVL_TEMP          (1)
#define TRACE_LVL_SYS           (1)
...
typedef enum
{
    APP_EVENT_PRE_CONNECT_LOCK = BIT(6),
    APP_EVENT_BACKLIGHT_LOCK = BIT(7),
    APP_EVENT_LVGL_INPUT_PIN_LOCK = BIT(8),
