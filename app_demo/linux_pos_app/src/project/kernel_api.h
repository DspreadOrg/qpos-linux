...
GLOBAL int Memcmp_(const void *str1, const void *str2, size_t n);
GLOBAL void * Memcpy_(void *dest, const void *src, size_t n);
GLOBAL void * Memset_(void *str, int c, size_t n);
GLOBAL size_t Strlen_(const char *str);
