...
const socket_errno_map_t  errno_message_map[] = {
    {SOCK_ERR_STEP_PARA ,         "socket param error"   },
    {SOCK_ERR_STEP_GETHOSTBYNAME, "dns fail"     },
    {SOCK_ERR_STEP_CREATESOCKET , "create socket fail"   },
    {SOCK_ERR_STEP_CONNECT ,      "server connect fail"   },
    {SOCK_ERR_STEP_SEND ,         "send fail"     },
    {SOCK_ERR_STEP_RECV ,         "recv fail"     },
	{SOCK_ERR_STEP_PARSE ,        "parse" },
