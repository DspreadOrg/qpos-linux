...
lv_color_t lv_palette_lighten(lv_palette_t p, uint8_t lvl)
{
    static const lv_color_t colors[][5] = {
        ...
        {LV_COLOR_MAKE(0xF0, 0x7D, 0x75), LV_COLOR_MAKE(0x70, 0xDB, 0x9D), LV_COLOR_MAKE(0x1A, 0x27, 0x32), LV_COLOR_MAKE(0x8F, 0x99, 0xA3), LV_COLOR_MAKE(0xFF, 0xEE, 0xB3)},
    };
...
lv_color_t lv_palette_darken(lv_palette_t p, uint8_t lvl)
{
    static const lv_color_t colors[][4] = {
        ...
        {LV_COLOR_MAKE(0xF0, 0x7D, 0x75), LV_COLOR_MAKE(0x70, 0xDB, 0x9D), LV_COLOR_MAKE(0x1A, 0x27, 0x32), LV_COLOR_MAKE(0x8F, 0x99, 0xA3)},
    };
